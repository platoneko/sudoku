...
cc.Class({
    ...
    onResize: function () {
        ...
        if (window.orientation==90 || window.orientation==-90 || (ss.width > ss.height)&&!cc.sys.isMobile) {
            ...
            this.container.getComponent(cc.Layout).type = cc.Layout.Type.HORIZONTAL;
            this.container.getComponent(cc.Layout).resizeMode = cc.Layout.ResizeMode.CONTAINER;
            this.container.getComponent(cc.Layout).horizontalDirection = cc.Layout.HorizontalDirection.board_TO_plugins;
            this.container.getComponent(cc.Layout).padding = (ss.width - 960) / 4;
            this.container.getComponent(cc.Layout).spacingX = (ss.width - 960) / 2;

            this.board.setContentSize(640, 640);
            this.board.getComponent(cc.Widget).isAlignHorizontalCenter = false;
            this.board.getComponent(cc.Widget).isAlignVerticalCenter = true;
            this.board.getComponent(cc.Widget).verticalCenter = 0;

            this.plugins.setContentSize(320, 500);
            this.plugins.getComponent(cc.Widget).isAlignHorizontalCenter = false;
            this.plugins.getComponent(cc.Widget).isAlignVerticalCenter = true;
            this.plugins.getComponent(cc.Widget).verticalCenter = 0;

            this.plugins.getComponent(cc.Layout).type = cc.Layout.Type.VERTICAL;
            ...
            if (ss.width / ss.height < 1.5) {
                this.container.getComponent(cc.Layout).padding = 0;
                this.getComponent(cc.Layout).spacingX = 0;
                this.board.setContentSize(540, 640);
                this.plugins.setContentSize(320, 500);
            }
        }
        else {
            ...
            this.container.getComponent(cc.Layout).type = cc.Layout.Type.VERTICAL;
            this.container.getComponent(cc.Layout).resizeMode = cc.Layout.ResizeMode.CONTAINER;
            this.container.getComponent(cc.Layout).verticalDirection = cc.Layout.VerticalDirection.TOP_TO_BOTTOM;
            this.container.getComponent(cc.Layout).padding = 10;
            this.container.getComponent(cc.Layout).spacingY = (ss.height - 960) / 3;

            this.board.setContentSize(640, 580);
            this.board.getComponent(cc.Widget).isAlignVerticalCenter = false;
            this.board.getComponent(cc.Widget).isAlignHorizontalCenter = true;
            this.board.getComponent(cc.Widget).horizontalCenter = 0;
            ...
            this.plugins.setContentSize(640, 200);
            this.plugins.getComponent(cc.Widget).isAlignVerticalCenter = false;
            this.plugins.getComponent(cc.Widget).isAlignHorizontalCenter = true;
            this.plugins.getComponent(cc.Widget).horizontalCenter = 0;
            this.plugins.getComponent(cc.Layout).type = cc.Layout.Type.VERTICAL;
            this.plugins.getComponent(cc.Layout).spacingY = 10;
            ...
            if (ss.height / ss.width < 1.5) {
                ...
                this.container.getComponent(cc.Layout).spacingY = 0;
                this.container.getComponent(cc.Layout).padding = 3;
                this.menuBar.node.setContentSize(640, 70);
                this.board.setContentSize(640, 560);
                this.plugins.setContentSize(640, 170);
